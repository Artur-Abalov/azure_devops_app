              ...
              return Column(
                ...
                children: [
                  if (ctrl.author?.descriptor != null) ...[
                    Row(
                      children: [
                        Expanded(child: Text(ctrl.author!.displayName!, style: context.textTheme.headlineLarge)),
                        MemberAvatar(userDescriptor: ctrl.author!.descriptor, radius: 60, tappable: false),
                      ],
                    ),
                  ],
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (ctrl.myWorkItems.isNotEmpty) ...[
                            if (ctrl.todaysCommitsPerRepo.isNotEmpty) const SizedBox(height: 10),
                            Text(
                                  ...
                                  child: Text.rich(
                                    TextSpan(
                                      children: [
                                        ...
                                        TextSpan(text: '${item.fields.systemTeamProject} (${item.fields.systemState})'),
                                      ],
                                    ),
                                  ),
                                ),
